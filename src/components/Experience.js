...
const timelineItems = [
  {
    ...
    organization: "Corporate Academy",
    location: "Mirpur, Dhaka",
    period: "Jan 2025 – May 2025",
    status: "Completed",
    description:
      "Supported the maintenance, enhancement, and deployment of company and client WordPress websites, delivering responsive interfaces and reliable production updates.",
    achievements: [
      "Maintained and enhanced company and client WordPress websites through theme customization and plugin configuration.",
      "Developed responsive, user-friendly front-end interfaces with Elementor, HTML, CSS, and JavaScript.",
      "Extended WordPress functionality with PHP template edits, custom logic, and performance optimizations.",
      "Managed content updates, bug fixes, feature enhancements, and production deployments across multiple live websites.",
    ],
    technologies: [
      "WordPress",
      "Elementor",

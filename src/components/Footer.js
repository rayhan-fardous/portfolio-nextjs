...
const socialLinks = [
  ...
  { label: "Email", href: "mailto:rayhanfardous@gmail.com", icon: Mail },
];

export default function Footer() {
  return (
    <footer id="contact" className="relative overflow-hidden border-t border-[var(--border-default)] bg-[var(--bg-elevated)] px-6 py-16 sm:px-8">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="grid gap-12 border-b border-[var(--border-default)] pb-12 lg:grid-cols-[1.45fr_0.75fr_0.9fr] lg:gap-16">
          <div>
            <Link href="/" className="inline-flex items-center gap-1.5 text-xl font-black tracking-wider text-t-primary">
            ...
            <a href="mailto:rayhanfardous@gmail.com" className="mt-7 inline-flex items-center gap-2 rounded-full bg-[var(--btn-primary-bg)] px-5 py-3 text-sm font-semibold text-[var(--btn-primary-text)] transition-transform duration-300 hover:-translate-y-0.5">
          ...
          <div>
            ...
            <a href="mailto:rayhanfardous@gmail.com" className="mt-5 block break-all text-sm font-medium text-t-secondary transition-colors hover:text-indigo-500">
              rayhanfardous@gmail.com
            </a>
